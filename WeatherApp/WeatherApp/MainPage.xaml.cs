...
namespace WeatherApp
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        private List<Weather> WeatherData()
        {
            ...
            tempList.Add(new Weather { Temp = "23", Date = "Tuesday 18", Icon = "weather.png" });
            tempList.Add(new Weather { Temp = "28", Date = "Wednesday 19", Icon = "weather.png" });
            tempList.Add(new Weather { Temp = "22", Date = "Thursday 20", Icon = "weather.png" });
            tempList.Add(new Weather { Temp = "25", Date = "Friday 21", Icon = "weather.png" });
